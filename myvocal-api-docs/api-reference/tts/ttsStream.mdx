...
<ParamField body="voiceSettings" type="object">
  ...
  <Expandable title="Toggle object">
    <ParamField body="stability" type="number" default="0.7">
      <div>a decimal in the range <code>0.1</code> to <code>1</code> inclusive, with a recommended default value of <code>0.7</code>. Any value in that range is accepted; no fixed step is enforced.</div>
